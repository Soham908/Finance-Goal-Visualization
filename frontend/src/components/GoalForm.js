...
import { TextField, Button, Box, MenuItem, Select, InputLabel, FormControl, Chip, Grid } from "@mui/material";
...
const GoalForm = () => {
  ...
  return (
    ...
    <Grid container display="flex" direction="column">
      <Grid item md={8} sx={{ backgroundColor: 'red', height: '50%' }}>
      <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2, flexGrow: 1, height: '100%' }}>
      <TextField
        label="Goal Name"
        name="goalName"
        value={goal.goalName}
    ...
    <Grid item md={4} sx={{ backgroundColor: 'yellow', height: '50%' }}>
    <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2, flexGrow: 1, height: '100%' }}>
      <TextField
        label="Goal Name"
        name="goalName"
